...
def read_data_no_outliers(dataset, method_name):
    '''parses data in given train and test data directories with outliers removed
    ...
    if method_name == "IF":
        train_data_dir = os.path.join('data',dataset,'new_data_if', 'train')
        test_data_dir = os.path.join('data',dataset,'new_data_if', 'test')
    else:
        train_data_dir = os.path.join('data',dataset,'new_data_svm', 'train')
        test_data_dir = os.path.join('data',dataset,'new_data_svm', 'test')
